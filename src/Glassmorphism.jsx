...
import "./glass-full-environment.css";
...
export default function Glassmorphism({ onBack }) {
  return (
    <main className="glassmorphism-page">
      ...
      <section className="glass-demo-section">
        <div className="glass-demo-scene">
          <div className="glass-environment" aria-hidden="true">
            <div className="environment-glow glow-cyan" /><div className="environment-glow glow-violet" /><div className="environment-glow glow-pink" />
            <div className="environment-orb orb-left" /><div className="environment-orb orb-right" />
            <div className="glass-ribbon ribbon-one" /><div className="glass-ribbon ribbon-two" /><div className="glass-ribbon ribbon-three" /><div className="glass-ribbon ribbon-four" />
          </div>
          <div className="glass-demo-card">
            <div className="glass-card-top"><span>Frosted Glass Effect</span><span>Soft blur · Minimal UI</span></div>
            <div className="glass-card-center"><h2>Glass<br />Morphism</h2><span className="glass-ui-badge">UI Background</span></div>
            <div className="glass-card-bottom"><span>Premium Design Asset</span><span>Editable Example</span></div>
          </div>
        </div>
      ...
      <button className="glass-bottom-back" onClick={onBack}><ArrowLeft size={18} /> BACK TO LIBRARY</button>
    </main>
  );
}
