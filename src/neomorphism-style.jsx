...
export default function NeomorphismStyle({onNavigate}){
 ...
 <section className="neo-hero"><div className="neo-intro"><span>03 / NEOMORPHISM</span><h1>Soft.<br/><em>Made tactile.</em></h1><p className="neo-lead">A surface you can almost feel.</p><p>Neomorphism creates the illusion that controls are moulded from the same physical surface — raised by light, pressed by shadow.</p><div className="neo-palette"><i/><i/><i/><i/><i/></div></div><div className="neo-panel"><span className="panel-label">TACTILE SYSTEM / 01</span><h2>CONTROL<br/><em>PANEL</em></h2><div className="neo-controls"><button className="neo-raised"><Sun size={20}/></button><button className="neo-raised power"><Power size={20}/></button><button className="neo-pressed"><Volume2 size={18}/></button></div><div className="neo-slider"><span/><i/></div><small>RAISED / PRESSED</small></div></section>
 <section className="neo-section"><div className="neo-label">02<br/><b>THE IDEA</b></div><div><h2>One surface.<br/><em>Two directions.</em></h2><p>Light makes an object feel raised. Dark shadow makes it feel pressed. Both belong to the same surface, creating a soft physical illusion.</p><div className="neo-compare"><article><button className="neo-raised"><span>+</span></button><b>RAISED</b><small>LIGHT OUT / FORM UP</small></article><article><button className="neo-pressed"><span>−</span></button><b>PRESSED</b><small>SHADOW IN / FORM DOWN</small></article></div></div></section>
