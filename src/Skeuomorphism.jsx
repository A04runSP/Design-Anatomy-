...
export default function Skeuomorphism({ onBack }) {
  ...
  return <main className="skeuo-page">
    ...
    <section className="skeuo-hero">
      ...
      <div className="skeuo-hero-grid">
        ...
        <div className="desk-scene" aria-label="Skeuomorphic desk scene">
          ...
          <div className="wood-panel"><span className="wood-grain grain-one"></span><span className="wood-grain grain-two"></span></div>
          ...
          <button className="brass-knob" onClick={() => setKnob(v => (v + 1) % 4)} style={{ "--turn": `${knob * 25}deg` }} aria-label="Turn knob"><span></span></button>
          <div className="desk-label">PHYSICAL METAPHOR</div>
        </div>
      </div>
    </section>

    <section className="skeuo-section">
      <div className="skeuo-heading"><span>01</span><h2>THE PARTS OF SKEUOMORPHISM</h2></div>
      <div className="skeuo-parts">{parts.map(([n, t, d]) => <article key={n} className="material-card"><b>{n}</b><div><h3>{t}</h3><p>{d}</p></div></article>)}</div>
    </section>

    <section className="skeuo-section">
      <div className="skeuo-heading"><span>02</span><h2>THE SKEUOMORPHIC TOOLKIT</h2></div>
      <div className="toolkit-grid">
        ...
        <article className="tool-card glass-tool"><div className="tool-object glass-object"><span>GLASS</span></div><b>HIGHLIGHTS</b><p>Reflections and translucent layers explain how a surface catches light.</p></article>
    ...
    <section className="skeuo-section">
      <div className="skeuo-heading"><span>03</span><h2>PHYSICAL → DIGITAL</h2></div>
      <div className="translation">
        <article className="translation-object"><span>01</span><b>PHYSICAL OBJECT</b><div className="physical-card"><div className="real-switch"></div><strong>LIGHT<br/>SWITCH</strong></div></article>
        <i>→</i>
        <article className="translation-object"><span>02</span><b>VISUAL METAPHOR</b><div className="metaphor-card"><div className="round-button"></div><strong>PRESS</strong></div></article>
        <i>→</i>
      ...
      <p className="skeuo-intro">The user recognises the physical reference before fully understanding the interface.</p>
    </section>

    <section className="skeuo-section">
      <div className="skeuo-heading"><span>04</span><h2>WHY IT WORKS</h2></div>
    ...
    <section className="skeuo-section two-col">
      <div><div className="skeuo-heading"><span>05</span><h2>WHERE IT WORKS</h2></div><ul><li>Music applications and creative tools</li><li>Educational interfaces and simulations</li><li>Interfaces based on physical equipment</li><li>Products where familiarity matters</li><li>Experiences where material storytelling adds meaning</li></ul></div>
      <div><div className="skeuo-heading"><span>06</span><h2>WHERE IT STRUGGLES</h2></div><ul><li>Dense information systems</li><li>Very small screens</li><li>Interfaces requiring extreme simplicity</li><li>When realistic decoration competes with content</li><li>When metaphor becomes harder to understand than the action</li></ul></div>
    </section>

    <section className="skeuo-section">
      <div className="skeuo-heading"><span>07</span><h2>SKEUOMORPHISM vs FLAT DESIGN</h2></div>
      <div className="versus"><article className="versus-skeuo"><div className="versus-icon raised-button"></div><h3>SKEUOMORPHISM</h3><p>Physical metaphor · texture · depth · detail</p></article><article className="versus-flat"><div className="versus-icon flat-button"></div><h3>FLAT DESIGN</h3><p>Abstract representation · simplicity · clean surfaces · minimal decoration</p></article></div>
      <p className="choice-note">Neither is automatically better. <strong>The right choice depends on the experience you're creating.</strong></p>
    </section>
